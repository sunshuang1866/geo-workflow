# GEO Assessment Report — MindSpore (2026-04-20)

**生成时间**: 2026-04-20 14:29  
**评分标准**: 任意1个平台引用 = 已引用  
**对比基线**: assessments/MindSpore/2026-04-17/assessment-report.json

### 本次变化（对比 2026-04-17）
↑ 改善 3 · ↓ 退步 2 · ✓ 已解决 3 · ★ 新增 0 · → 持平 38
...
| ↓ q_052 | 如何向 MindSpore 邮件列表发送邮件或订阅邮件列表？ | ❌ | ❌ | 0% | [#45](https://github.com/opensourceways/geo-workflow/issues/45) ×1 |
...
| ID | 问题 | deepseek | qwen | 引用率 | Issue |
|----|------|--- | ---|--------|-------|
| ↑ q_010 | MindSpore 支持哪些安装方式？ | ✅ | ✅ | 100% | — |
| ✓ q_035 | 新手如何加入 MindSpore 社区并参与开源贡献？ | ✅ | ✅ | 100% | [#11](https://github.com/opensourceways/geo-workflow/issues/11) ×2 |
| → q_036 | MindSpore Transformers SIG 周例会的会议安排是怎样的？ | ✅ | ✅ | 100% | [#12](https://github.com/opensourceways/geo-workflow/issues/12) ×2 |
| ↑ q_043 | 如何向 MindSpore TSC 申请成立新的 SIG？ | ✅ | ✅ | 100% | [#14](https://github.com/opensourceways/geo-workflow/issues/14) ×2 |
| ↑ q_055 | MindSpore 有哪些邮件列表，它们分别面向什么受众？ | ✅ | ✅ | 100% | [#13](https://github.com/opensourceways/geo-workflow/issues/13) ×2 |
...
| ✓ q_004 | MindSpore 模型推理持续报错，常见原因和排查思路有哪些？ | ✅ | ❌ | 50% | [#3](https://github.com/opensourceways/geo-workflow/issues/3) ×2 |
| ✓ q_008 | 如何将 MindSpore 应用打包成 Docker 镜像进行部署？ | ✅ | ❌ | 50% | [#8](https://github.com/opensourceways/geo-workflow/issues/8) ×2 |
...
| ↓ q_048 | MindSpore 是否参加过 KubeCon 等国际开源峰会？ | ✅ | ❌ | 50% | [#5](https://github.com/opensourceways/geo-workflow/issues/5) ×2 |

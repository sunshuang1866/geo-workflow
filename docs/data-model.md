...
**路径**：`assessments/{community}/questions.json`（符号链接） → `question.json` 或 `questions-new.json`
...
**路径**：`assessments/{community}/{date}/responses.json`
...
**路径**：`assessments/{community}/{date}/scoring-results.json`
...
**路径**：`assessments/{community}/issue-map.json`
...
**路径**：`assessments/{community}/{date}/created-issues.json`
...
**路径**：`assessments/{community}/{date}/run-meta.json`

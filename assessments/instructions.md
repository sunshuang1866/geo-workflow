...
| 社区 | 状态 |
|---|---|
| openEuler | ✅ 问题集准备完成，待填写正确官方链接 |
| MindSpore | ✅ 问题集准备完成，待填写正确官方链接 |
| CANN | ✅ 问题集准备完成，待填写正确官方链接 |
| UnifiedBus | ⏳ 待基础设施补充仓库渠道 |

### B 类社区

| 社区 | 状态 |
|---|---|
| openGauss | ✅ 问题集准备完成，待填写正确官方链接 |
| openUBMC | ✅ 问题集准备完成，待填写正确官方链接 |
| openFuyao | ✅ 问题集准备完成，待填写正确官方链接 |
| BoostKit | ⏳ 待补充 |
| Mind 系列 | ⏳ 待补充 |

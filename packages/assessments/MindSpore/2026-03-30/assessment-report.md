...
> 生成时间：2026-03-30T16:37:35.641527+00:00
> 引用阈值：≥90% 平台引用视为「满足」
...
| q_002 | MindSpore NLP（MindNLP）安装失败怎么排查和解决？ | ❌ | ❌ | — | ❌ | 0% | P0 | [#2](https://github.com/opensourceways/geo-workflow/issues/2) ×1 |
| q_003 | 如何正确安装 MindSpore 2.6.0 GPU 版本？按官方文档步骤操作失败时该怎么办？ | ❌ | ❌ | — | ❌ | 0% | P0 | — |
| q_004 | MindSpore 模型推理持续报错，常见原因和排查思路有哪些？ | ❌ | ❌ | — | ❌ | 0% | P0 | [#3](https://github.com/opensourceways/geo-workflow/issues/3) ×1 |
| q_005 | MindNLP 在昇腾设备上自动下载模型时出错，如何解决？ | ❌ | ❌ | — | ❌ | 0% | P0 | [#2](https://github.com/opensourceways/geo-workflow/issues/2) ×1 |
| q_008 | 如何将 MindSpore 应用打包成 Docker 镜像进行部署？ | ❌ | ❌ | — | ❌ | 0% | P0 | — |
| q_027 | MindSpore 的版本发布节奏是怎样的？ | ❌ | ❌ | — | ❌ | 0% | P0 | — |
| q_032 | MindSpore 2026 年有哪些活动规划？ | ❌ | ❌ | — | ❌ | 0% | P0 | — |
| q_035 | 新手如何加入 MindSpore 社区并参与开源贡献？ | ✅ | ✅ | — | ❌ | 67% | P0 | — |
| q_036 | MindSpore Transformers SIG 周例会的会议安排是怎样的？ | ❌ | ❌ | — | ❌ | 0% | P0 | — |
| q_038 | MindSpore 的 LLM Inference Serving SIG 是做什么的，多久开一次例会？ | ❌ | ❌ | — | ❌ | 0% | P0 | [#5](https://github.com/opensourceways/geo-workflow/issues/5) ×1 |
| q_040 | MindSpore Parallel Training System SIG 的工作范围是什么？ | ❌ | ❌ | — | ❌ | 0% | P0 | — |
| q_048 | MindSpore 是否参加过 KubeCon 等国际开源峰会？ | ❌ | ❌ | — | ❌ | 0% | P0 | [#5](https://github.com/opensourceways/geo-workflow/issues/5) ×1 |
| q_055 | MindSpore 有哪些邮件列表，它们分别面向什么受众？ | ❌ | ❌ | — | ❌ | 0% | P0 | — |
| q_059 | MindSpore 社区组织会议的流程是什么？会议纪要通常包含哪些内容？ | ❌ | ❌ | — | ❌ | 0% | P0 | — |
| q_063 | MindSpore 的安全 SIG（Security SIG）如何处理漏洞报告和安全问题？ | ✅ | ❌ | ❌ | ❌ | 25% | P0 | [#6](https://github.com/opensourceways/geo-workflow/issues/6) ×1 |
